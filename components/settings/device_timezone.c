...
static const device_timezone_t k_zones[] = {
    {"europe/kaliningrad", "Калининград (UTC+2)", "EET-2"},
    {"europe/moscow", "Москва (UTC+3)", "MSK-3"},
    {"europe/samara", "Самара (UTC+4)", "SAMT-4"},
    {"asia/yekaterinburg", "Екатеринбург (UTC+5)", "YEKT-5"},
    {"asia/omsk", "Омск (UTC+6)", "OMST-6"},
    {"asia/krasnoyarsk", "Красноярск (UTC+7)", "KRAT-7"},
    {"asia/irkutsk", "Иркутск (UTC+8)", "IRKT-8"},
    {"asia/yakutsk", "Якутск (UTC+9)", "YAKT-9"},
    {"asia/vladivostok", "Владивосток (UTC+10)", "VLAT-10"},
    {"asia/magadan", "Магадан (UTC+11)", "MAGT-11"},
    {"asia/kamchatka", "Камчатка (UTC+12)", "PETT-12"},
     ...
     * file. */
    {"europe/london", "Лондон (UTC+0/+1)", "GMT0BST,M3.5.0/1,M10.5.0"},
    {"europe/berlin", "Берлин (UTC+1/+2)", "CET-1CEST,M3.5.0,M10.5.0/3"},
    {"america/new_york", "Нью-Йорк (UTC-5/-4)", "EST5EDT,M3.2.0,M11.1.0"},
    {"utc", "UTC (UTC+0)", "UTC0"},
};
