...
(() => {
  ...
  const DICT = {
    ...
    'fl.log': ['Журнал', 'Log'],
    'fl.port_help': ['Порт не появляется — поставьте драйвер CP210x или CH340; плата не отвечает — зажмите BOOT, коротко нажмите RESET, отпустите BOOT и попробуйте снова.',
                     'No port shows up - install the CP210x or CH340 driver; the board does not answer - hold BOOT, tap RESET, let go of BOOT and try again.'],
