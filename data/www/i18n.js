...
(() => {
  ...
  const DICT = {
    ...
    'hw.f.button_sleep': ['F1 — сон', 'F1 - sleep'], 'hw.f.button_quick_menu': ['Quick_menu — быстрые настройки', 'Quick_menu - quick panel'],
    ...
    'hw.s.button_sleep': ['F1', 'F1'], 'hw.s.button_quick_menu': ['Quick_menu', 'Quick_menu'], 'hw.s.button_prev': ['F3', 'F3'], 'hw.s.button_next': ['F4', 'F4'],
