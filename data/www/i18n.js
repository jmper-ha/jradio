...
(() => {
  ...
  const DICT = {
    ...
    'hw.lead': ['Что подключено к модулю и на какие выводы. Результат — файл board_options.h для сборки прошивки.',
                'What is wired to the module, and to which pins. The result is a board_options.h to build the firmware with.'],
